...
export const HERO_TEMPLATES: HeroTemplate[] = [
	...
	h("ash", "Ash", 34, 2, 5, 0, "#e45b26", "48% 18%", "50% 15%"),
	h("barty", "Barty", 30, 1, 5, 0, "#1b89c6", "50% 18%", "50% 15%"),
	h("esme", "Esme", 32, 1, 6, 0, "#d7dc2d", "49% 18%", "50% 15%"),
	h("obrus", "Obrus", 35, 0, 4, 0, "#d8c372", "55% 18%", "55% 15%"),
	h("reaver", "Reaver", 34, 1, 2, 1, "#58bebe", "50% 22%", "50% 18%"),
	h("toki", "Toki", 33, 1, 4, 0, "#550c80", "47% 35%", "50% 32%"),
	h("korag", "Korag", 35, 1, 2, 2, "#841316", "50% 18%", "50% 15%"),
	h("rei", "Rei", 34, 2, 4, 0, "#7d7db7", "47% 18%", "50% 15%"),
	h("rowan", "Rowan", 32, 2, 3, 0, "#f6a31e", "50% 18%", "50% 15%"),
];
